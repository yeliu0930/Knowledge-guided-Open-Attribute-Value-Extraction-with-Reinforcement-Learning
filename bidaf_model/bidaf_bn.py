...
Q = Bidirectional(GRU(lstm_dim, return_sequences=True, dropout=dropout_rate, recurrent_dropout=0.0) )(quest_emb)
Q = BatchNormalization()(Q)
C = Bidirectional(GRU(lstm_dim, return_sequences=True, dropout=dropout_rate, recurrent_dropout=0.0) )(cand_emb)
...
M1 = Bidirectional(GRU(lstm_dim, return_sequences=True, dropout=dropout_rate, recurrent_dropout=0.0) )(G)
M2 = Bidirectional(GRU(lstm_dim, return_sequences=True, dropout=dropout_rate, recurrent_dropout=0.0) )(M1)
...
mm.compile(AdamWithWeightnorm(0.01), 'binary_crossentropy')
